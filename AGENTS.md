...
This repo uses [gstack](https://github.com/garrytan/gstack) and
[superpowers](https://github.com/obra/superpowers) for AI-assisted workflows.

Skill routing — retrieve the latest from:
- https://github.com/garrytan/gstack/blob/main/README.md#the-sprint
...
3. **Follow library conventions** as documented — preferred configuration style, recommended annotations, idiomatic patterns. Prefer the library's own abstractions over hand-rolled equivalents (e.g. use autoconfigure beans instead of manual `@Bean` wiring when the library provides them).
